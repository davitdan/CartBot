...
var app = {
    ...
    deviceready: function () {
        ...
        function vibrate() {
            ...
            window.navigator.vibrate([35, 0, 20]);

        }
        function vibratePattern() {
            window.navigator.vibrate([70, 0, 50, 0, 30, 0, 20]);

        }

        disconnectButton.ontouchstart = vibrate;

        document.getElementById("stop").addEventListener("click", vibratePattern);
        document.getElementById("stopMode").addEventListener("click", vibratePattern);
        document.getElementById("auto").addEventListener("click", vibrate);
        document.getElementById("manual").addEventListener("click", vibrate);
        document.getElementById("settings").addEventListener("click", vibrate);
        document.getElementById("mode").addEventListener("click", vibrate);
        document.getElementById("connect").addEventListener("click", vibrate);
        document.getElementById("aboutUs").addEventListener("click", vibrate);
        document.getElementById("refreshButton").addEventListener("click", vibratePattern);
